...
import { Caption, TechnologyItem } from '..'
...
const Technologies = () => {
  ...
  return (
    <StyledContainer>
      ...
      />
      <ListWrapper>
        <TechnologyItem rating={3} img={mock1} />
        <TechnologyItem rating={4} img={mock2} />
        <TechnologyItem rating={2} img={mock3} />
        <TechnologyItem rating={4} img={mock4} />
      </ListWrapper>
    </StyledContainer>
  )
}
